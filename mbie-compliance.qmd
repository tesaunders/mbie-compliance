...
Read in CONZUL data and a list of subject categories used by Web of Science.
...
Summarise and get total pubs by subject.
...
```{r}
#| label: 2021-compliance-discipline
